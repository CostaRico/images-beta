...
use rico2\yii2images\behaviors\ImageBehave;
use rico2\yii2images\models\Image;
use yii\db\Connection;
use yii\db\ActiveRecord;
use yii\helpers\ArrayHelper;
use org\bovigo\vfs\vfsStream;
use rico2\yii2images\controllers\ImagesController;
...
class ImageBehaveTest extends DbTestCase
{
    ...
    public function testGetImage()
    {
        ...
        $this->assertTrue(get_class($image) == 'rico2\yii2images\models\Image');
